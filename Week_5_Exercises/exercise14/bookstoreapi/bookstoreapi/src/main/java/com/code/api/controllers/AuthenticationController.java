...
import com.code.api.responses.LoginResponse;
import com.code.api.services.AuthenticationService;
...
public class AuthenticationController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<Customer> register(@RequestBody RegisterDTO registerUserDto) {
